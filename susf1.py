...
cl = treetc.LINE()
#cl.login(qr=True) #ขี้งอล#
cl.login(token="EpoEccd7jW7z1pjEbEh0.f82yJqit6VPpJVVLP5ZgOa.tlmP+TrCqVtRKp1Ioo4rR3V9PhJ8G6TD57jhUCxax2c=")
cl.loginResult()
kt = ks = ki = kk = kc = cl
print "Login ™Ŧяәәƅoŧ"
reload(sys)
