...
cl = treetc.LINE()
#cl.login(qr=True) #คนของใจ#
cl.login(token="EpYJolO6lES1GC6wOur0.UJkrQY+ues/WindSoGMQCa.VgOBnCPriszybl3GWberKPQQWqSdfmdHyqv/3T8FCgg=")
cl.loginResult()
kt = ks = ki = kk = kc = cl
print "Login ™Ŧяәәƅoŧ"
reload(sys)
                ...
                if wait['invite'] == True:
                     ...
                     for s in groups.members:
                         if _name in s.displayName:
                             cl.sendText(msg.to, _name + " อยู่ในกลุ่มนี้")
                         else:
...
#-------------------------------------------------------------------------#            
                ...
                if wait["contact"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"contact get to on")
                    else:
                        cl.sendText(msg.to,"contact get to on")
                else:
                    wait["contact"] = True
                ...
                if wait["contact"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"contact get to off")
                    else:
                        cl.sendText(msg.to,"contact get to off")
                else:
                    wait["contact"] = False
                ...
                try:
                    ...
                    if strnum == "off":
                        ...
                        if wait["lang"] == "JP":
                            cl.sendText(msg.to,"It off the invitation was denied ?? \ Please send by specifying the number of people when you turn on")
                        else:
                        ...
                        if wait["lang"] == "JP":
                            ...
                            cl.sendText(msg.to,strnum + "The team declined to create the following invitation")
                except:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"The value is incorrect")
                    else:
...
#-------------------------------------------------------------------------#
            ...
            elif msg.text.lower() == 'check message':
                if wait["lang"] == "JP":
            ...
            elif msg.text in ["Com on","Com:on","Comment on","com:on","comment:on"]:
            ...
            elif msg.text in ["Com off","Com:off","Comment off","com:off","comment:off"]:
            ...
            elif msg.text in ["Com","Comment","com","comment"]:
                ...
                if len(n.decode("utf-8")) > 30:
                    ...
                    wait["cName"] = n
                    cl.sendText(msg.to,"Clock Name Changed to:" + n)
                ...
                if wait["clock"] == True:
                    ...
                    cl.sendText(msg.to,"Please Turn on Hours")
...
#-------------------------------------------------------------------------#
                ...
                cl.sendText(msg.to,"Send Contact")
#-------------------------------------------------------------------------#                
            elif msg.text in ["like:me","like me"]: #สถานะบัญชีหลักของ Botlike ทั้งหมด
                ...
                try:
                  ...
                  pass
 #-------------------------------------------------------------------------#               
            elif msg.text in ["like:friend","like friend"]: #สถานะเพื่อน Botlike ทั้งหมด
                print "[Command]Like executed"
                ...
                if msg.toType == 2:
                    ...
                    if group.invitee is not None:
                        ...
                        if wait["lang"] == "JP":
                            ...
                            cl.sendText(msg.to,"Invitations are missing")
                else:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"No invites")
                    else:
 ...
 #-------------------------------------------------------------------------#                   
                ...
                for target in targets:
                    try:
                        ...
                        cl.sendText(msg.to,"Target abolished!")
                        break
                    except:
                        cl.sendText(msg.to,"Fail !")
                        break
...
#-------------------------------------------------------------------------#
 ...
 #-------------------------------------------------------------------------#           
                ...
                cl.sendText(msg.to, "The Pap is in Set")
            elif msg.text in ["Papimage","Papim","Pap"]:
                cl.sendImageWithURL(msg.to,wait["pap"])
            elif "setvideo: " in msg.text:
                wait["pap"] = msg.text.replace("Setvideo: ","")
                cl.sendText(msg.to,"Video Has Been Sent To")
...
#-------------------------------------------------------------------------#
                ...
                wait["blacklist"] = {}
                cl.sendText(msg.to,"Blacklist Has Been Cleaned")
                ...
                if wait["blacklist"] == {}:
                    ...
                    cl.sendText(msg.to,"List of Banlist")
                    num=1
                    msgs="*Blacklist*"
                ...
                if wait["blacklist"] == {}:
                    ...
                    cl.sendText(msg.to,"Blacklists list")
                    h = ""
                ...
                if msg.toType == 2:
                    ...
                    for tag in wait["blacklist"]:
                        matched_list+=filter(lambda str: str == tag, gMembMids)
                    if matched_list == []:
                        cl.sendText(msg.to,"No Blacklist List")
                        return
...
#-------------------------------------------------------------------------#									
        if op.type == 17:
            ...
            cl.sendText(op.param1,"ยินดีต้อนรับ "+cl.getContact(op.param2).displayName +"\nเข้าสู่ กลุ่ม"+ str(ginfo.name)+ ", ขอบคุณนะคะที่เข้ามาร่วมแบ่งปันความสุข  \n(*´･ω･*)")
            print "สมาชิกเข้าร่วม"
	if op.type == 15:
            random.choice(KAC).sendText(op.param1, cl.getContact(op.param2).displayName + ", มีโอกาสดีๆๆ แล้วพบกันใหม่น๊าาาา \n(*´･ω･*)")
