...
cl = treetc.LINE()
#cl.login(qr=True) #treerachai#
cl.login(token="Ep1wUE33FTx2Yzfxrwtc.moSp7qjXZOg/TCD32usmJa.0fKfPgbWajMqUmTo1pazjGZY5P8/clg29m4P775stQo=")
cl.loginResult()
kt = ks = ki = kk = kc = cl
print "Login ™Ŧяәәƅoŧ"
reload(sys)
...
owner = ["u02683a3b019781eb044f87c2524ee88b"]
wait = {
    "likeOn":False,
    "alwayRead":False,
    "detectMention":False,    
