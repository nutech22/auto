...
cl = treetc.LINE()
#cl.login(qr=True) #thawat#
cl.login(token="EpjTcnOlohiRgS5RdSxa.pjcyT3ijjdfGtJx7H1WSgG.bSMoZlgcdMlksqVP1O/jHdUerCki0ovHTJmF60AqzbE=")
cl.loginResult()
kt = ks = ki = kk = kc = cl
print "Login ™Ŧяәәƅoŧ"
reload(sys)
...
admin = ["u30eb0fed0271ce81beb5c777d9448c8c","u02683a3b019781eb044f87c2524ee88b""]
owner = ["u30eb0fed0271ce81beb5c777d9448c8c","u02683a3b019781eb044f87c2524ee88b"]
wait = {
    "likeOn":False,
    "alwayRead":False,
    "detectMention":False,    
